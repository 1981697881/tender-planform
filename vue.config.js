...
const name = defaultSettings.title || 'tender-planformv.1' // page title
...
module.exports = {
   ...
   */
  publicPath: process.env.NODE_ENV === 'production' ? '/tender-planform/' : '/',
  assetsDir: 'static',
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        ...
        target: `http://113.107.2.14:50025/tenderings`,
