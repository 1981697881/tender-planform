      ...
      <el-row :gutter="20">
        <el-col :span="24">
          <el-form-item :label="'子采购包'" prop="orgAttr">
            <el-table class="list-main" :data="list1" border size="mini" :highlight-current-row="true" @row-click="perClick">
              <el-table-column
...
export default {
  ...
  data() {
    return {
      ...
      columns2:[{text: '供应商名称', name: 'starName'},
        {text: '联系人地址', name: 'roleType'},
        {text: '联系人', name: 'roleName'},
        {text: '联系人电话', name: 'roleName'},
        {text: '是否开局发票', name: 'roleName'},
        {text: '发票编码', name: 'roleName'},
        {text: '支付方式', name: 'roleName'}],
      pidS: [],
      rules: {
      },
    };
